import '../expenses_payment_one_screen/widgets/listglobe1_item_widget.dart';
import 'bloc/expenses_payment_one_bloc.dart';
import 'models/expenses_payment_one_model.dart';
...
class ExpensesPaymentOneScreen extends StatelessWidget {
  const ExpensesPaymentOneScreen({Key? key})
      : super(
          key: key,
        );

  static Widget builder(BuildContext context) {
    return BlocProvider<ExpensesPaymentOneBloc>(
      create: (context) => ExpensesPaymentOneBloc(ExpensesPaymentOneState(
        expensesPaymentOneModelObj: ExpensesPaymentOneModel(),
      ))
        ..add(ExpensesPaymentOneInitialEvent()),
      child: ExpensesPaymentOneScreen(),
    );
  }
    ...
    return SafeArea(
      child: Scaffold(
            ...
            children: [
              ...
              Expanded(
                child: Padding(
                  ...
                  child: BlocSelector<ExpensesPaymentOneBloc,
                      ExpensesPaymentOneState, ExpensesPaymentOneModel?>(
                    selector: (state) => state.expensesPaymentOneModelObj,
                    builder: (context, expensesPaymentOneModelObj) {
                      return ListView.separated(
                        ...
                        itemCount: expensesPaymentOneModelObj
                                ?.listglobe1ItemList.length ??
                            0,
                        itemBuilder: (context, index) {
                          Listglobe1ItemModel model = expensesPaymentOneModelObj
        ...
        floatingActionButton: CustomFloatingButton(
          ...
          width: 50,
          backgroundColor: appTheme.whiteA70001,
          decoration: FloatingButtonStyleHelper.fillWhiteA70001,
          child: CustomImageView(
            svgPath: ImageConstant.imgMenuIndigo400,
            height: getVerticalSize(
              25.0,
            ),
            width: getHorizontalSize(
