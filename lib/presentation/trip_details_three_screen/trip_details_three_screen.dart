import 'bloc/trip_details_three_bloc.dart';
import 'models/trip_details_three_model.dart';
...
class TripDetailsThreeScreen extends StatelessWidget {
  const TripDetailsThreeScreen({Key? key}) : super(key: key);

  static Widget builder(BuildContext context) {
    return BlocProvider<TripDetailsThreeBloc>(
        create: (context) => TripDetailsThreeBloc(TripDetailsThreeState(
            tripDetailsThreeModelObj: TripDetailsThreeModel()))
          ..add(TripDetailsThreeInitialEvent()),
        child: TripDetailsThreeScreen());
  }

  @override
  Widget build(BuildContext context) {
    mediaQueryData = MediaQuery.of(context);
    return BlocBuilder<TripDetailsThreeBloc, TripDetailsThreeState>(
