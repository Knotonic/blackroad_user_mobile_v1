    ...
    return RepositoryProvider(
      ...
      child: BlocProvider<OtpBloc>(
          create: (context) => OtpBloc(
              OtpState(OtpModelObj: OtpModel()), context.read<SignUpNetwork>())
            ..add(OtpInitialEvent()),
          child: OtpScreen()),
    );
  }
                              ...
                              child: Column(
                                  ...
                                  children: [
                                    ...
                                    CustomElevatedButton(
                                        onTap: () {
                                          Logger.log("what is the arguments");
                                          Logger.log(args);
