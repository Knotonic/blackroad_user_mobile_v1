import 'bloc/map_one_bloc.dart';
import 'models/map_one_model.dart';
...
class MapOneScreen extends StatelessWidget {
  const MapOneScreen({Key? key})
      : super(
          key: key,
        );

  static Widget builder(BuildContext context) {
    return BlocProvider<MapOneBloc>(
      create: (context) => MapOneBloc(MapOneState(
        mapOneModelObj: MapOneModel(),
      ))
        ..add(MapOneInitialEvent()),
      child: MapOneScreen(),
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<MapOneBloc, MapOneState>(
