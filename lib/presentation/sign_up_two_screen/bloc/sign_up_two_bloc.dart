...
import 'package:blackroad_v1/presentation/sign_up_two_screen/models/sign_up_two_model.dart';
...
class SignUpTwoBloc extends Bloc<SignUpTwoEvent, SignUpTwoState> {
  ...
  _onInitialize(
    ...
    emit(state.copyWith(mobilenumberController: TextEditingController()));
  }
}
